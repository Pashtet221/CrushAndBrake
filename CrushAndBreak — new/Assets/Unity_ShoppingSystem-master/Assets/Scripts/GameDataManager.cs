...
public static class GameDataManager
{
    ...
    {
        if (PlayerPrefs.HasKey(playerData.coinsKey))
        {
            playerData.coins = PlayerPrefs.GetInt(playerData.coinsKey);
        }
    }

    static void SaveCoins()
    {
        PlayerPrefs.SetInt(playerData.coinsKey, playerData.coins);
        PlayerPrefs.Save();
    }
